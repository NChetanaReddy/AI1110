...
Question(12.13.6.4):Suppose that $90\%$ of people are right-handed. What is the probability that
...
Let p be the probability that the picked person is right-handed and q be the probability that the picked person is left-handed.
\begin{align}
\pr{X=k} = \comb{n}{r} p^kq^{n-k}
\end{align}
Cummulative distribution function of X:
\begin{align}
F_X(k)=\pr{X \leqslant k}
\end{align}
\begin{align}
F_X(k)=\sum_{r=0}^{r=k}\pr{X=r}=\sum_{r=0}^{r=k} \comb{n}{r} p^rq^{n-r}
\end{align}
Where
\begin{align}
n=10\nonumber\\
...
q=0.1\nonumber
\end{align}
k denotes the values that the random variable X can take.\\
Probability that atmost 6 are right-handed among 10 is \pr{X \leqslant 6}
\begin{align}
F_X(6)&=\sum_{r=0}^{r=6} \comb{10}{r} (0.9)^r(0.1)^{10-r}\\&=0.0128
\end{align}
%\begin{abstract}
